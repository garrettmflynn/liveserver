...
import { OSCClient, SessionsClient, UserPlatform, WebsocketClient, WebRTCClient, HTTPClient } from '../../../../src/frontend';
...
let services = [new SessionsClient(), new OSCClient(), new WebsocketClient(), new WebRTCClient(), new HTTPClient()]
