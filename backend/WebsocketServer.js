    ...
    async init() {
      ...
      this.server.on('connection', function (client) {
        ...
        this.server.on('upgrade', async (request, socket, head) => {
            ...
            /**
             *  {
             *    id or _id: unique identifier string (can be autogenerated, used to keep tabs of owners of data within mongodb also),
             *    username:string,
             *    password:string, 
             *    props:{} //dict of whatever properties
             *    etc... //arbitrary data
             * }
             */
            ...
            this.wss.handleUpgrade(request, socket, head, (ws) => {
                this.wss.emit('connection', ws, subprotocols, request);
              });
            // })
        });
